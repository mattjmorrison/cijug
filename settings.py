...
DATABASE_NAME = 'cijug'             # Or path to database file if using sqlite3.
DATABASE_USER = 'postgres80'             # Not used with sqlite3.
...
SECRET_KEY = '+dz*a$t$_u34utlxu(wrs!!$++7*9xa_bme1dmrjdpe5zs^0x&'
...
MIDDLEWARE_CLASSES = (
    ...
    'cijug.microblog.middleware.SqlLoggingMiddleware',
)
