...
def index(request):
    return shortcuts.render_to_response('microblog/templates/index.html', {'blogs':models.Blog.objects.select_related().all()})
...
def edit(request, id):
    instance = models.Blog.objects.select_related().get(id=id)
